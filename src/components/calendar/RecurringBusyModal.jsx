...
export default function RecurringBusyModal({ open, onOpenChange }) {
  ...
  const [untilMode, setUntilMode] = useState('forever'); // 'forever' | 'date'
  ...
  // Fetch existing recurring busy entries for this user
  ...
  // Pre-fill from existing recurring entry
  useEffect(() => {
  ...
  const handleConfirm = async () => {
    ...
    // Delete old recurring entries for this user
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={() => { setUntilMode('date'); setShowDateRange(true); }}
                  className={`flex-1 py-2 rounded-xl text-xs font-bold transition-all border-2 ${
