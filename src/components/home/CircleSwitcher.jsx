...
export default function CircleSwitcher() {
  ...
  return (
    <div data-swipe-ignore className="flex gap-2.5 overflow-x-auto pb-1 px-1 scrollbar-hide touch-pan-x overscroll-x-contain" style={{ WebkitOverflowScrolling: 'touch' }}>
      {circles.map((circle) => {
